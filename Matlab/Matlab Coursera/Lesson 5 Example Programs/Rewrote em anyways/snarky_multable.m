...
% the intergers 1 through N.
% MULTABLE(N,M) returns an N-by-M matrix
% Both input aguments must be positive
% integers.
...
if error_count >=3
    error_count = 0;%revert to the basic error message
    error('What part of "positive interger" do you not understand?');
end
table = (1:n)' * (1:m);
